<template>
    <div class="map-container">
        ...
        <div v-else-if="mapCenter" class="map">
            <l-map :zoom="13" :center="mapCenter" class="map">
...
const loadAllCoordinates = async () => {
    ...
    console.log(nearbyCoords.value)
...
const mapCenter = computed(() => {
    ...
    if (nearbyCoords.value.length > 0) {
        return nearbyCoords.value[0].coords;
    }
    return null;
});
